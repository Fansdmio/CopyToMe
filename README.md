...
CopyToMe 是一款绕过禁止粘贴限制，并且可以使用AI用于部分考试的辅助工具

## 应用场景

1. 禁止粘贴的场景，使用 `CTRL+K` 让程序模拟人打字
2. 部分考试场景, 使用AI问答之后 使用模拟输入绕过禁止粘贴限制,从而辅助考试
...
![image-20260527195114239](./images/image-20260527195114239.png)

### 设置

![image-20260527195351353](./images/image-20260527195351353.png)
